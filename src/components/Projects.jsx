...
const Projects = () => {
    return (
        <div><motion.h1 whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: -100 }} transition={{ duration: 1 }} className='my-20 text-center text-4xl '>Projects</motion.h1>
            <div className="">{PROJECTS.map((project, index) => {
                return <div className="mb-8 flex flex-wrap lg:justify-center" key={index}>
                    ...
                    <motion.div whileInView={{ opacity: 1, x: 0 }} initial={{ opacity: 0, x: 100 }} transition={{ duration: 1 }} className="w-ful max-w-xl lg:w-3/4">
